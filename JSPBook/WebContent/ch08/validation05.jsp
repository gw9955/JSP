...
<script type="text/javascript">
	function checkMember() {
		...
		let regExpPhone = /^\d{3}-\d{3,4}-\d{4}$/; // 전화번호 형태만 가능. \d{3}: 숫자3개. \d{3,4}: 숫자3이상4이하
		let regExpEmail = /^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}$/i; // 이메일 형태만 가능. i:ignore(대소문자 구별 안한다)
		// 폼 object
