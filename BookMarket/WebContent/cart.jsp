		...
		<div style="padding-top:50px;">
			<table class="table table-hover">
				...
				<%
						...
						for(BookVO bookVO : cartList) {
							// 금액 = 가격 * 수량
							double total = bookVO.getUnitPrice() *
									bookVO.getQuantity();
				...
				<tr>
					...
					<td><fmt:formatNumber value="<%=bookVO.getUnitPrice()%>" pattern="#,###" /></td>
					<td><%=bookVO.getQuantity()%></td>
					<td><fmt:formatNumber value="<%=totalBig%>" pattern="#,###" /></td>
					<td>
						<a href="removeCart.jsp?id=<%=bookVO.getBookId()%>"
